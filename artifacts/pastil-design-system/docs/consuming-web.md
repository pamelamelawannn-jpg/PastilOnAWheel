# Consuming Pastil Tracker Design System in web apps

Read `artifacts/pastil-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/pastil-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/pastil-design-system/styles.css";
```
...
`node_modules/@workspace/pastil-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/pastil-design-system/components/ui/button";
import { cn } from "@workspace/pastil-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/pastil-design-system/hooks/use-toast";
```
...
`@workspace/pastil-design-system/components/ui/button`. Run the app's typecheck
