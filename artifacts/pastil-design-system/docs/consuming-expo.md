# Consuming Pastil Tracker Design System in Expo apps

Read `artifacts/pastil-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/pastil-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/pastil-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/pastil-design-system/lib/native-theme";
import { useColors } from "@workspace/pastil-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/pastil-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/pastil-design-system/components/native/badge";
import { Button } from "@workspace/pastil-design-system/components/native/button";
import { Card } from "@workspace/pastil-design-system/components/native/card";
```
...
Import and render
`@workspace/pastil-design-system/components/native/button`, then run Expo
