# Pastil Tracker Design System design system
...
workspace package (`@workspace/pastil-design-system`): other artifacts depend
...
- `docs/references/` — retained Pastil logo, source extraction manifest, and
  component inventory/build contracts. Read the relevant reference file before
  changing an inventoried component.
- `SKILL.md` — source-derived Pastil usage rules and the current pilot/later-chunk
  boundary.
...
`@workspace/pastil-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/pastil-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/pastil-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/pastil-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/pastil-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/pastil-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/pastil-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/pastil-design-system/docs/migrating-expo.md`
