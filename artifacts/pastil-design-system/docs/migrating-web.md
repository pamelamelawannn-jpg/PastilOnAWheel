# Migrating web UI to Pastil Tracker Design System

Read `artifacts/pastil-design-system/docs/AGENTS.md` and
`artifacts/pastil-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/pastil-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/pastil-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/pastil-design-system/hooks/use-toast`
