# Migrating Expo UI to Pastil Tracker Design System

Read `artifacts/pastil-design-system/docs/AGENTS.md` and
`artifacts/pastil-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/pastil-design-system/lib/native-theme` and
  `@workspace/pastil-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/pastil-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/pastil-design-system` and retains only
